...
class NginxConfig {
 public:
  ...
  std::unordered_map<std::string, std::string> get_paths_from_config();
  std::unordered_map<std::string, std::string> getHandlerNames();
  std::unordered_map<std::string, std::string> getMapReverseProxyPath() const;
};
